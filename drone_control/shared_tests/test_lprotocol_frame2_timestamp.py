...
背景：2026-07-10真机测试发现`land()`双条件确认(unlock_sta==0且
...
使用方式：在各子模块的 test_lprotocol_frame2_timestamp.py 中导入：
    from shared_tests.test_lprotocol_frame2_timestamp import TestFrame2Timestamp, TestLandTimeoutGaveupBit
"""
import time
