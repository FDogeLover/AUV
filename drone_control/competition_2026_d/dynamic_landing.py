...
class LandingConfig:
    ...
    descend_high_m_s: float = 0.25
    descend_mid_m_s: float = 0.16
    descend_low_m_s: float = 0.08
    reacquire_climb_m_s: float = 0.12
    terminal_max_s: float = 0.50
    terminal_max_drop_m: float = 0.10
    terminal_max_error_m: float = 0.05
    terminal_max_relative_speed_m_s: float = 0.08
    terminal_max_uncertainty_m: float = 0.06
