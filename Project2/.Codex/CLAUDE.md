...
| 16 | navigate() yaw修正回路 | 🟡/两轮开启复测 | 2026-07-18定位旧navigate()额外`-vyaw`把负反馈变正反馈；两轮开启组净yaw变化绝对值分别较关闭组改善60%/23%，但第二轮yaw全范围13.00°反而略差于关闭组12.17°，保持默认关闭并补足3+3样本 |
...
| 27 | fire_patrol长直线横向偏差：掠过切角+yaw残余耦合 | 🟡/两轮开启复测 | 15cm判据已解决0.4m提前切角；两轮航向保持开启组的长直线均值/中位/P95均优于关闭基线，但第二轮改善仅11%/13%/11%，最坏峰值升至0.1666m，典型改善可重复、最坏值未改善 |
