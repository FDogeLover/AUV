...
| 27 | fire_patrol长直线横向偏差：掠过切角+yaw残余耦合 | 🟡/部分验证 | 2026-07-18关闭航向保持完整路线验证：9个巡航航点均在0.136~0.150m切换、无超时，长直线起始横向误差由0.378~0.392m降至0.033~0.136m；剩余0.089~0.138m横向峰值待开启航向保持做A/B |
